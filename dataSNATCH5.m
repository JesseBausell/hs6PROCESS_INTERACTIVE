function flaggedROWS_verified = dataSNATCH5(HS6_data,deptH,flaggedROWS,lambdA,biNS,ACS_KEY,ind_KEY)
% dataSNATCH5
% Jesse Bausell
% November 24, 2016
%
% This program takes HS6 data that has already been flagged. It looks at
% all of the previously flagged IOP rows and compares them with all other
...
%
% Inputs:
% HS6_data - IOP Data from ac-s or hs6
